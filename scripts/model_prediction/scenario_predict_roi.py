...
from kapoorlabs_vollseg.care_lightning.schedulers import _Schedulers
...
@dataclass
class CarePredictClass:
    parameters: RoiParams
    train_data_paths: RoiDataPaths
    experiment_data_paths: CareExperimentPaths
