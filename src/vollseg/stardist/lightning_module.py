...
of :class:`vollseg._lightning.CareModule` (same ``BaseModule`` parent,
...
class StarDistModule(BaseModule):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(network=network, loss_func=loss_func, optim_func=optim_func,
                         scheduler=scheduler)
    ...
    def predict_step(self, batch, batch_idx):
        ...
        :class:`vollseg._lightning.CarePredictionDataset` — one tile
