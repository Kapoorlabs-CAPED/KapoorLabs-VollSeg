...
New code should use :class:`vollseg.CARETrainer` (PyTorch + Lightning).
"""
...
class CARETrainerKeras:
    ...
    def fit(
        ...
        *,
        ...
        model = CAREBackboneKeras(self.config, name=self.model_name, basedir=os.fspath(self.model_dir))
