...
class CAREDenoiser:
    ...
    def from_checkpoint(
        ...
        **kwargs,
        ...
        return cls(CAREBackbone.from_checkpoint(checkpoint, **backbone_kwargs), **kwargs)
    ...
    def predict(
        ...
        **_ignored,
        ...
        if image.ndim != 3:
            raise ValueError(f"CAREDenoiser.predict expects a 3D volume, got ndim={image.ndim}")
        ...
        denoised = stitch_tiles(predictions, image.shape, overlap_fraction=self.tile_overlap)
