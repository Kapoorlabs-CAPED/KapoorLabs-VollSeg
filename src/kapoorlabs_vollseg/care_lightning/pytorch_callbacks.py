...
import psutil
from lightning.pytorch.callbacks import DeviceStatsMonitor, LearningRateFinder
...
class EventCountProgressBar(Callback):
    ...
    def on_predict_start(self, trainer, pl_module):
        ...
        # Reset the module's detection buffer and counter
        pl_module._recent_detections = []
        pl_module._total_events = 0
