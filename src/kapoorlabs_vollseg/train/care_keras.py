"""CARE denoising trainer (keras / csbdeep) — legacy.

New code should use :class:`kapoorlabs_vollseg.CARETrainer` (PyTorch + Lightning).
"""
...
class CARETrainerKeras:
    """Train a csbdeep CARE denoising network."""
    ...
    def fit(
        ...
        *,
        ...
        model = CAREBackboneKeras(
            self.config, name=self.model_name, basedir=os.fspath(self.model_dir)
        )
