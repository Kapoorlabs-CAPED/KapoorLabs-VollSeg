...
# Heavy optional dep — only required when the user picks the ``lars`` optimizer.
# Guarded so the rest of the optimizer registry imports without lightly installed.
try:
